        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <div className="text-container">
              ...
              <p>
                Corso Landing Page Template uses visitors' data for the
              ...
              <ol className="li-space-lg">
                ...
                <li>
                  To sell or market Corso Landing Page products and services to
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="text-container last">
                  ...
                  <p>
                    Corso Landing Page uses tracking technology on the landing
                    page, in the Applications, and in the Platforms, including
                    mobile application identifiers and a unique Corso user ID to
                  ...
                  <p>
                    By visiting Corso or using the Services you agree to the use
                    of cookies in your browser and HTML-based emails. You visit
                    a website, by using any of the Services, or submitting via
                    the Services you consent and use of your basic{" "}
                  ...
                  >
                    ...
                    <div className="form-group">
                      ...
                      >
                        ...
                        <option className="select-option" value="Delete data">
                          Delete my data
                        </option>
                        <option className="select-option" value="Show me data">
                          Show me my data
                        </option>
                      </select>
                      <div className="help-block with-errors" />
                    ...
                    <div className="form-group checkbox">
                      <input
                        ...
                        required
                      />
                      I have read and agree to Corso's{" "}
                    ...
                    <div className="form-message">
                      <div id="pmsgSubmit" className="h3 text-center hidden" />
                    </div>
                  </form>
                </div>{" "}
            ...
            {/* end of row */}
            <a className="btn-solid-reg" href="index.html">
              BACK
            </a>
          </div>{" "}
          {/* end of col*/}
